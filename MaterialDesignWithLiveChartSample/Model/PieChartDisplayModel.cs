...
namespace MaterialDesignWithLiveChartSample.Model
{
    public class PieChartNode : ViewModelBase
    {
        ...
        public ObservableCollection<ChartValues<ObservableValue>>? ControlValue { get => controlValue; set => controlValue=value; }
        private SeriesCollection? pieChartSeries;
        public SeriesCollection? PieChartSeries { get => pieChartSeries; set => pieChartSeries = value; }
        private string? pieChartName;
        public string? PieChartName { get => pieChartName; set => pieChartName = value; }
        // TODO : fix this
